...
// type FruitCounts = typeof fruitCounts type NewSingleFruitCount = { [K in keyof FruitCounts]: {} }
...
// const singleFruitCount: NewSingleFruitCount = { apple: {}, pear: {}, banana: {}, }
...
// type NewSingleFruitCount = { [K in keyof FruitCounts]: { [K2 in K]: number } }
// type NewSingleFruitCount = {
//   [K in keyof FruitCounts]: {
//     [K2 in K]: number
//   }
...
// const singleFruitCount: NewSingleFruitCount = { apple: { apple: 2, }, pear: { pear: 4, }, banana: { banana: 26, }, }
// const singleFruitCount: NewSingleFruitCount = {
//   apple: {
//     apple: 2,
//   },
...
// type NewSingleFruitCount = { [K in keyof FruitCounts]: { [K2 in K]: number } }[keyof FruitCounts]
// type NewSingleFruitCount = {
//   [K in keyof FruitCounts]: {
//     [K2 in K]: number
//   }
